			...
			if( IsRoadsMapMode )
				{
					...
					#if ROAD_TYPE_ID == 0
						float3 RoadTypeColor = float3( 0.1, 0.5, 0.05 );
						float BrightnessMul = 1.0f; #1.2
						float BrightnessBias = 0.06f;
					#elif ROAD_TYPE_ID == 1
						float3 RoadTypeColor = float3( 0.8, 0.4, 0.1 );
						float BrightnessMul = 1.08f; #1.28
						float BrightnessBias = 0.075f;
					#elif ROAD_TYPE_ID == 2
						float3 RoadTypeColor = float3( 0.5, 0.3, 0.2 );
						float BrightnessMul = 1.1f; #1.35
						float BrightnessBias = 0.09f;
					#elif ROAD_TYPE_ID == 3
						float3 RoadTypeColor = float3( 0.6, 0.6, 0.6 );
						float BrightnessMul = 1.0f; #1.2
						float BrightnessBias = 0.06f;
					#endif
